# Decision Register — MCP Platform
...
**Decision:** The platform supports three federated chat interfaces: (1) CopilotKit React module for embedded HITL evidence review (`client/`); (2) OpenWebUI as a remote chat surface federated with DIAL Core; (3) LibreChat as an alternative remote chat surface with document upload support. All three route through ContextForge. None may be externally exposed without Keycloak gating.
...
- Stale planning docs (PLATFORM_OVERVIEW.md, SPRINT_PLAN.md, _DEPRECATED/POST_DIAL_REPLACEMENT_ARCHITECTURE.md) that reference Agno/n8n or DIAL Core as operational — moved to _DEPRECATED/
