# Utility Tools — Legacy Script Index

This subtree now acts as the legacy per-script reference set for the operational `tools/utilities/scripts/` pack.

For the authoritative intake catalog, status tracking, and broader tool context, use:

- [Utilities Intake Catalog](/mnt/c/Users/matts/Projects/TheBigOne/dial-stack/docs/wiki/tools/utilities/INDEX.md)
- [Utilities Script Pack](/mnt/c/Users/matts/Projects/TheBigOne/dial-stack/docs/wiki/tools/utilities/scripts/INDEX.md)
