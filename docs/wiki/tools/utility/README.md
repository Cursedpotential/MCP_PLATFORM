# Utility Tools Wiki — Legacy Script Docs

The authoritative intake catalog now lives at:
...
This directory is retained because it already contains detailed script pages that are still useful as local context.
